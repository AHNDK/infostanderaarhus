...
<footer class="footer" role="contentinfo">
  <section class="footer--content-primary">
    ...
    <strong>Telefon:</strong> +45 4187 4601
  </section>
  <section class="footer--content-secondary" id="kontakt">
    ...
    <div class="footer--lead">
      ...
      <p class="footer--focus">Ring <a href="tel:41856563"><strong>4187 4601</strong></a> eller udfyld formularen</p>
      <p>
    ...
    <form action="contact_form.php" method="post" id="contact-form">
      ...
      <input type="email" id="email" name="email" class="contact-form--email" placeholder="Indtast din e-mail-adresse" required>
      <input type="hidden" id="message" name="message" value="">
      <button class="contact-form--button" type="submit" id="contactSubmitButton">
...
<script>
  ...
  ga('create', 'UA-45214152-1', 'infostanderaarhus.dk');
  ga('send', 'pageview');
</script>
</body>
</html>
